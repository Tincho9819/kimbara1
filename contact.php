...
$address = "info.kimbara@gmail.com";
...
if(empty($email)) {
	...
	$error = 'Ha ingresado una dirección incorrecta. Pruebe nuevamente.';
}
////////////////////////
...
if (!empty($error)) {
 ...
 $e_reply = "Puedes contactarte con $name via email a: $email.";
 ...
 if(mail($address, $e_subject, $msg, $headers)) {
	 ...
	 echo "<p><span>Gracias por contactarnos!</span> Su mensaje ha sido enviado</p>";
	 echo "</div>";
	 echo "</fieldset>";
